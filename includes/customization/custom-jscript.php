...
function themezee_custom_jscript_navigation() { 
	...
	$params = array(
		'menuTitle' => __('Menu', 'zeeDynamic_language')
	);
...
function themezee_custom_jscript_posts() { 
	...
	// Set Parameters array
	$params = array(
		'loadMoreText' => __('Load More Posts', 'zeeDynamic_language'),
		'loadingText' => __('Loading posts...', 'zeeDynamic_language'),
		'noMoreText' => __('No more posts to load.', 'zeeDynamic_language'),
		'startPage' => $paged,
		'maxPages' => $max,
